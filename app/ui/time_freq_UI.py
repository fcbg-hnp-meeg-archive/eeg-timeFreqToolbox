...
class Ui_TimeFreq(object):
    def setupUi(self, MenuWindow):
        ...
        self.epochingPanel = QtWidgets.QGroupBox(self.verticalGroupBox)
        self.epochingPanel.setCheckable(True)
        self.epochingPanel.setChecked(False)
        self.epochingPanel.setObjectName("epochingPanel")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.epochingPanel)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout()
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.eventsButton = QtWidgets.QPushButton(self.epochingPanel)
        self.eventsButton.setObjectName("eventsButton")
        self.verticalLayout_6.addWidget(self.eventsButton)
        self.eventsLabel = QtWidgets.QLabel(self.epochingPanel)
        self.eventsLabel.setText("")
        self.eventsLabel.setObjectName("eventsLabel")
        self.verticalLayout_6.addWidget(self.eventsLabel)
        self.horizontalLayout_6.addLayout(self.verticalLayout_6)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout()
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_3 = QtWidgets.QLabel(self.epochingPanel)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_4.addWidget(self.label_3)
        self.label_4 = QtWidgets.QLabel(self.epochingPanel)
        self.label_4.setObjectName("label_4")
        self.verticalLayout_4.addWidget(self.label_4)
        self.horizontalLayout_6.addLayout(self.verticalLayout_4)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.tmin = QtWidgets.QLineEdit(self.epochingPanel)
        self.tmin.setObjectName("tmin")
        self.verticalLayout_5.addWidget(self.tmin)
        self.tmax = QtWidgets.QLineEdit(self.epochingPanel)
        self.tmax.setObjectName("tmax")
        self.verticalLayout_5.addWidget(self.tmax)
        self.horizontalLayout_6.addLayout(self.verticalLayout_5)
        self.horizontalLayout_6.setStretch(0, 2)
        self.horizontalLayout_6.setStretch(1, 1)
        self.horizontalLayout_6.setStretch(2, 1)
        self.dataLayout_2.addWidget(self.epochingPanel)
    ...
    def retranslateUi(self, MenuWindow):
        ...
        self.epochingPanel.setTitle(_translate("MenuWindow", "Epoching"))
        self.eventsButton.setText(_translate("MenuWindow", "Select Events"))
        self.label_3.setText(_translate("MenuWindow", "tmin"))
        self.label_4.setText(_translate("MenuWindow", "tmax"))
