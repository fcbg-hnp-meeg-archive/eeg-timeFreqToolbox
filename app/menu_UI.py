...
class Ui_MenuWindow(object):
    def setupUi(self, MenuWindow):
        ...
        self.epochingButton.setMinimumSize(QtCore.QSize(0, 25))
        self.epochingButton.setMaximumSize(QtCore.QSize(16777215, 25))
        self.epochingButton.setFlat(False)
        self.epochingButton.setObjectName("epochingButton")
        self.mainLayout.addWidget(self.epochingButton)
